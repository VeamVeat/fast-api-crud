...
class TestAuthor:
    ...
    def test_get_author_by_id(self, client, create_author):
    ...
    def test_get_authors(self, client, create_author):
    ...
    def test_update_author(self, client, create_author):
        data = {
    ...
    def test_optional_update_author_by_id(self, client, create_author):
        data = {
            "age": settings.TEST_UPDATE_AGE_AUTHOR
        }
    ...
    def test_add_book_to_author_id(self, client, create_author, create_book):
        data = {"book_id": 1}
