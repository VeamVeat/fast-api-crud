...
def test_create_book(client, data_create_book):
...
def test_get_books(client, create_book):
...
def test_update_book_by_id(client, create_book):
    data = {
...
def test_optional_update_book_by_id(client, create_book):
    data = {
        "title": settings.TEST_UPDATE_TITLE_BOOK
    }
...
def test_delete_book_by_id(client, create_book):
